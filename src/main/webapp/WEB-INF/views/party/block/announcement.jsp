	...
	<div class="tab-content">
		<div class="tab-pane active" id="app">
			<div>
				...
				<dl>
					<dt>评论上墙</dt>
					<dd>
					1、每个人发布的评论实时显示，每条停留5秒；<br />
					2、当有多人同时发布评论出现排队时，对值（V=被赞数-被踩数）进行降序排序，V值相同的按发布时间降序排序；<br />
					3、已在大屏幕上显示过的且未在队列中的评论，如果被点“赞”或“踩”后，将重新回到队列中，并按规则2排序显示；<br />
					4、当没人发布评论，也没有评论被点“赞”或“踩”，且此时队列为空时，将从所有评论中随机抽取一条显示。
</dd>
				</dl>
			</div>
		</div>
		...
		<div class="tab-pane" id="votes">
			...
			<div>
				<h4>投票规则</h4>
				<ul>
					<li>单人的投票上限为5票，且不可对单一节目重复投票；当且仅当投完5票后，其所投的票才有效</li>
